...
// Cross Module References
	BALANCE_API UClass* Z_Construct_UClass_ANPC_NoRegister();
	BALANCE_API UClass* Z_Construct_UClass_ANPC();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_Balance();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_ANPC_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_Balance,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ANPC, 1812868789);
	template<> BALANCE_API UClass* StaticClass<ANPC>()
	{
		return ANPC::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ANPC(Z_Construct_UClass_ANPC, &ANPC::StaticClass, TEXT("/Script/Balance"), TEXT("ANPC"), false, nullptr, nullptr, nullptr);
